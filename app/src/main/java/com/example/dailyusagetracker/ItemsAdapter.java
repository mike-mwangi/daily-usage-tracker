...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ViewHolder>{
    ...
    public ItemsAdapter(Context mContext, List<Data> myDataList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.amount.setText("Spent: Ksh."+data.getAmount());
        ...
        switch (data.getItem()){
            case "Food":
                ...
                break;
            case "Pool":
                holder.imageView.setImageResource(R.drawable.ic_pool);
                break;
            case "FIFA":
                holder.imageView.setImageResource(R.drawable.ic_fifa);
                break;
            case "Other":
                ...
                reference.child(postid).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(mContext, "Failed to delete item" +task.getException(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                dialog.dismiss();
